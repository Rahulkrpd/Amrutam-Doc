...
const WhyUs = () => {
    return (
        <div className='w-full bg-[#FFF7E2] min-h-screen flex flex-col justify-center items-center space-y-20 px-4'>

            <div className='space-y-3 flex justify-center flex-col items-center'>
                <h1 className='text-2xl md:text-4xl text-[#3A643C] font-semibold text-center'>Why Doctors Choose Us?</h1>
                <p className='text-[#4C4C4C] font-semibold text-center lg:text-xl px-4'>Unlock the Benefits of Smarter Healthcare Management and Patient Care</p>
            </div>
            {/* lower content */}
            <div className="w-full max-w-7xl space-y-10">

                {/* one of them text are of people */}
                <div className="m-2 md:m-20 p-4 md:p-10 flex flex-col md:flex-row justify-around items-center gap-10">
                    {/* Image */}
                    <div className="w-full md:w-1/2 flex flex-col items-center relative md:top-10">
                        <img
                            src="./phone.svg"
                            alt="phone"
                            className="w-16 h-16 sm:w-24 sm:h-24 md:w-26 md:left-20 md:top-24 relative top-10 left-6  "
                        />
                        <img src="./Groupmessage.svg" alt="message group" className="w-full h-auto mt-6 md:mt-10 max-w-full" />
                    </div>
                ...
                {/* third */}
                <div className="m-2 md:m-20 p-4 md:p-10 flex flex-col-reverse md:flex-row justify-between items-center gap-10">
                    {/* Left Section */}
                    <div className="w-full md:w-1/2 relative flex flex-col items-center md:items-start">
                        {/* Overlapping Icon */}
                        <div className="relative top-20 xs:left-14 rounded-full p-2 bg-[#DBDCC4] sm:left-30 md:left-30  xl:left-90">
                ...
                <div className="m-2 md:m-20 p-4 md:p-10 flex flex-col-reverse md:flex-row justify-between items-center gap-10">
                    ...
                    <div className="w-full md:w-1/2 relative flex flex-col items-center">
                        {/* Overlapping Icon */}
                        <div className="relative w-28 h-24 mb-6 top-12 left-14 md:top-20 md:left-40">
                            <img src="./Ellipse.svg" alt="background" className="absolute top-1 left-3
                              sm:w-20 h-full " />
